...
/*function edadUsuario(){
    ...
    let añoNacimiento = Number(prompt("Cual es su año de nacimiento?"));
    return añoActual - añoNacimiento;
}

console.log("su edad es",edadUsuario(), "años");

function salarioAnual(){
    const meses = 12;
    let salario = Number(prompt("Indique cual es su salario mensual en pesos:"));
    return salario * meses;
}

console.log("Su salario anual es ", salarioAnual()," pesos");


function salarioMensual(){
    const meses = 12;
    salario = Number(prompt("Indique cual es su salario anual en pesos:"));
    return salario / meses;
}

console.log("Su salario mensual es ", salarioMensual() ," pesos");
*/
...
let operador = "-";
let resultado;
let numeroA = Number(prompt("Ingrese su primer numero:"));
let numeroB = Number(prompt("Ingrese su segundo numero:"));
...
console.log("El resltado de sumar sus dos numeros es " ,resultado);
